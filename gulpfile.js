...
// pug to html
function html() {
  return gulp.src('assets/pug/pages/starter-kit/**.pug')
...
function watch(){
  browserSync.init({
      proxy: 'localhost/cuba/theme/calendar-advanced.html'
  });
  gulp.watch('assets/scss/**/*.scss', style);
  gulp.watch('assets/pug/pages/theme/calendar-advanced.pug', html);
